/*
Count Good Triplets in an Array - [Leetcode - 2179(Hard)]
=========================================================
...
void updateSegmentTree(int i, int l, int r, int updateIndex,
...
long long querySegmentTree(int queryStart, int queryEnd, int i, int l,
        int r, vector<long long>& segmentTree) {
...
int mid = l + (r - l) / 2;
long long left = querySegmentTree(queryStart, queryEnd, 2 * i + 1, l,
                   mid, segmentTree);
long long right = querySegmentTree(queryStart, queryEnd, 2 * i + 2,
                    mid + 1, r, segmentTree);
return left + right;
}
