/*
Weighted Word Mapping - [Leetcode - 3838(Easy)]
--------------------------------------------------
...
string mapWordWeights(vector<string>& words, vector<int>& weights) {
    ...
    for(auto &word : words){
        ...
        temp = temp % 26;
        char mappedChar = 'z' - temp; // reverse mapping
        result += mappedChar;
    }
    return result;
}
