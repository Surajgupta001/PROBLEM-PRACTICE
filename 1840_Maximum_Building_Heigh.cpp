/*
Maximum Building Height - [Leetcode - 1840(Hard)]
----------------------------------------------------
...
int maxBuilding(int n, vector<vector<int>>& restrictions) {
    ...
    for (int i = 1; i < m; i++) {
        ...
        // Maximum achievable peak in this segment
        long long peak = (leftHeight + rightHeight + dist) / 2;
...
int main() {
    ...
    cout << maxBuilding(n, restrictions) << endl; // 2

    n = 6;
    restrictions = {};
    cout << maxBuilding(n, restrictions) << endl; // 5
