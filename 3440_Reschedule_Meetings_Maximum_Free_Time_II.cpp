/*
Reschedule Meetings for Maximum Free Time II - [Leetcode - 3440(Medium)]
-------------------------------------------------------------------------
...
int main() {
    ...
    int maxFree = maxFreeTime(eventTime, startTime, endTime);
    cout << "Maximum free time after rescheduling: " << maxFree << endl;
