/*
Shortest Distance to Target String in a Circular Array - [Leetcode - 2515(Easy)]
----------------------------------------------------------------------------------
...
int closestTarget(vector<string>& words, string target, int startIndex) {
    ...
    for(int i=0; i<n; i++){
        if(words[i] == target){
            ...
            minDistance = min({minDistance, straightDistance, circularDistance});
        }
    }
...
int main () {
    ...
    cout << closestTarget(words1, target1, startIndex1) << endl; // 1
